...
build_hooks = {
    ...
    "installedbuild": partial(pbunreal.build_installed_build, bump_version=True),
    "installedbuildretry": partial(pbunreal.build_installed_build, bump_version=False),
    "installedbuildupload": pbunreal.upload_installed_build,
